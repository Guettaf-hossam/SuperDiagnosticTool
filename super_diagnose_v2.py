...
def main():
    ...
    console.print("[3] [bold magenta]SUPERMAN EYE[/bold magenta] (Everything + Disk Health, GPU, Startup Apps)")
    ...
    if mode == "1":
        ...
        console.print("[bold magenta]INITIATING SUPERMAN EYE SCAN...[/bold magenta]")
